...
$sql = "SELECT username,srno FROM signin WHERE email = ?";
  ...
  <div class="container">
    ...
    <div class="sideNavigation">
      ...
      <div class="sideNavButton">
        <button>
          <i class="fa-solid fa-plus"></i><span class="collapseText" onclick="newChat()">New Chat</span>
        </button>
      </div>
      ...
      <div class="actionList">
        ...
        <div class="location">
          <p>
            <i class="fa-solid fa-location-dot"></i><span>Pune, Maharashtra, India</span>
          </p>
    ...
    <div class="chatWindow">
      <div class="startContent">
        <h1>
          <span class="brandHello">Hello, <?php echo $username ?></span><br /><span class="brandQuestion">How can I help you today?</span>
        </h1>
        <br />
        <ul></ul>
        <div class="message">
          <p>Humans review some saved chats to improve Google AI. To stop this for future chats, turn off Gemini Apps Activity. If this setting is on, don't enter info you wouldn’t want reviewed or used. How it works
          <p id="dismiss" onclick="dismiss()">Dismiss</p>
        </div>
      </div>
      ...
      <div class="inputArea" id="inputArea">
        ...
        <input type="text" placeholder="Enter a prompt here" autocomplete="off" name="prompt" id="prompt" />
...
<div class="icon"><i class="${data.icon}"></i></div>
    ...
    sendRequest.addEventListener("click", () => {
      if (inputArea.value.trim().length > 0) {
        let prompt = inputArea.value.trim();
